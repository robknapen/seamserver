...
/**
 * Interface for data access objects that handle context related data.
 */
public interface ContextDao extends Dao {
	public ContextTO findById(Long id);
