/*  
 * RepresentativeFarmDao.java; March 31, 2010
 * ==============================================================================
...
/**
 * Interface for data access objects that handles representative farm data.
 * 
 * @author Rob Knapen; Alterra, Wageningen UR, The Netherlands
 */
public interface RepresentativeFarmDao extends Dao {
	 ...
	 */
	public Collection<RepresentativeFarmTO> findAll();

	/**
	 * Retrieves the instance with the specified id.
	 * 
	 * @param id of the instance to retrieve
	 * @return RepresentativeFarmTO instance, or null when not found
	 */
