/* gromit: PICAIndicatorGeneralListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for PICAIndicatorGeneralTO .java
 * ==============================================================================
...
public class PICAIndicatorGeneralListTO extends ArrayList<PICAIndicatorGeneralTO> implements Serializable, Cloneable	
{
    ...
    public PICAIndicatorGeneralListTO assignFrom(Set<PICAIndicatorGeneral> o)
    {
        clear();
        if (o != null) {
            for (PICAIndicatorGeneral obj : o)
            {
    			add(new PICAIndicatorGeneralTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<PICAIndicatorGeneral> assignTo(Set<PICAIndicatorGeneral> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<PICAIndicatorGeneral> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		PICAIndicatorGeneral dbItem = iter.next();
        		boolean found = false;
        		for (PICAIndicatorGeneralTO toItem : this)
        		{
            ...
            //can be updated! 
            for (PICAIndicatorGeneralTO toItem : this) {
            	for (PICAIndicatorGeneral dbItem : o) {
            ...
            for (PICAIndicatorGeneralTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new PICAIndicatorGeneral()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<PICAIndicatorGeneral> o)
    {
        if (o == null)
            return false;

        PICAIndicatorGeneralListTO to = new PICAIndicatorGeneralListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public PICAIndicatorGeneralListTO clone()
    {
        return (PICAIndicatorGeneralListTO) super.clone();
    }
}
