/* gromit: PICAIndicatorValueListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for PICAIndicatorValueTO .java
 * ==============================================================================
...
public class PICAIndicatorValueListTO extends ArrayList<PICAIndicatorValueTO> implements Serializable, Cloneable	
{
    ...
    public PICAIndicatorValueListTO assignFrom(Set<PICAIndicatorValue> o)
    {
        clear();
        if (o != null) {
            for (PICAIndicatorValue obj : o)
            {
    			add(new PICAIndicatorValueTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<PICAIndicatorValue> assignTo(Set<PICAIndicatorValue> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<PICAIndicatorValue> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		PICAIndicatorValue dbItem = iter.next();
        		boolean found = false;
        		for (PICAIndicatorValueTO toItem : this)
        		{
            ...
            //can be updated! 
            for (PICAIndicatorValueTO toItem : this) {
            	for (PICAIndicatorValue dbItem : o) {
            ...
            for (PICAIndicatorValueTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new PICAIndicatorValue()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<PICAIndicatorValue> o)
    {
        if (o == null)
            return false;

        PICAIndicatorValueListTO to = new PICAIndicatorValueListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public PICAIndicatorValueListTO clone()
    {
        return (PICAIndicatorValueListTO) super.clone();
    }
}
