/* gromit: PicaIndicatorListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for PicaIndicatorTO .java
 * ==============================================================================
...
public class PicaIndicatorListTO extends ArrayList<PicaIndicatorTO> implements Serializable, Cloneable	
{
    ...
    public PicaIndicatorListTO assignFrom(Set<PicaIndicator> o)
    {
        clear();
        if (o != null) {
            for (PicaIndicator obj : o)
            {
    			add(new PicaIndicatorTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<PicaIndicator> assignTo(Set<PicaIndicator> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<PicaIndicator> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		PicaIndicator dbItem = iter.next();
        		boolean found = false;
        		for (PicaIndicatorTO toItem : this)
        		{
            ...
            for (PicaIndicatorTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new PicaIndicator()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<PicaIndicator> o)
    {
        if (o == null)
            return false;

        PicaIndicatorListTO to = new PicaIndicatorListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public PicaIndicatorListTO clone()
    {
        return (PicaIndicatorListTO) super.clone();
    }
}
