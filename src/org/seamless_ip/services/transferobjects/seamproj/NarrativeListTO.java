/* gromit: NarrativeListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for NarrativeTO .java
 * ==============================================================================
...
public class NarrativeListTO extends ArrayList<NarrativeTO> implements Serializable, Cloneable	
{
    ...
    public NarrativeListTO assignFrom(Set<Narrative> o)
    {
        clear();
        if (o != null) {
            for (Narrative obj : o)
            {
    			add(new NarrativeTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Narrative> assignTo(Set<Narrative> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Narrative> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Narrative dbItem = iter.next();
        		boolean found = false;
        		for (NarrativeTO toItem : this)
        		{
            ...
            for (NarrativeTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Narrative()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Narrative> o)
    {
        if (o == null)
            return false;

        NarrativeListTO to = new NarrativeListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public NarrativeListTO clone()
    {
        return (NarrativeListTO) super.clone();
    }
}
