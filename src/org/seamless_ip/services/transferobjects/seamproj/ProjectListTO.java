/* gromit: ProjectListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for ProjectTO .java
 * ==============================================================================
...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.seamproj.Project", readonly=false, used=true)
@SuppressWarnings("serial")
public class ProjectListTO extends ArrayList<ProjectTO> implements Serializable, Cloneable	
{
    ...
    public ProjectListTO assignFrom(Set<Project> o)
    {
        clear();
        if (o != null) {
            for (Project obj : o)
            {
    			add(new ProjectTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Project> assignTo(Set<Project> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Project> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Project dbItem = iter.next();
        		boolean found = false;
        		for (ProjectTO toItem : this)
        		{
            ...
            for (ProjectTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Project()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Project> o)
    {
        if (o == null)
            return false;

        ProjectListTO to = new ProjectListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public ProjectListTO clone()
    {
        return (ProjectListTO) super.clone();
    }
}
