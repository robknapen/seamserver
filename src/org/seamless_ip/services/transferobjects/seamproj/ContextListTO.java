/* gromit: ContextListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for ContextTO .java
 * ==============================================================================
...
public class ContextListTO extends ArrayList<ContextTO> implements Serializable, Cloneable	
{
    ...
    public ContextListTO assignFrom(Set<Context> o)
    {
        clear();
        if (o != null) {
            for (Context obj : o)
            {
    			add(new ContextTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Context> assignTo(Set<Context> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Context> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Context dbItem = iter.next();
        		boolean found = false;
        		for (ContextTO toItem : this)
        		{
            ...
            for (ContextTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Context()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Context> o)
    {
        if (o == null)
            return false;

        ContextListTO to = new ContextListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public ContextListTO clone()
    {
        return (ContextListTO) super.clone();
    }
}
