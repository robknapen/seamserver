/* gromit: ExperimentQueueListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for ExperimentQueueTO .java
 * ==============================================================================
...
import org.seamless_ip.services.transferobjects.seamproj.ExperimentQueueTO;
...
public class ExperimentQueueListTO extends ArrayList<ExperimentQueueTO> implements Serializable, Cloneable	
{
    ...
    public ExperimentQueueListTO assignFrom(Set<ExperimentQueue> o)
    {
        clear();
        if (o != null) {
            for (ExperimentQueue obj : o)
            {
    			add(new ExperimentQueueTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<ExperimentQueue> assignTo(Set<ExperimentQueue> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<ExperimentQueue> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		ExperimentQueue dbItem = iter.next();
        		boolean found = false;
        		for (ExperimentQueueTO toItem : this)
        		{
            ...
            for (ExperimentQueueTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new ExperimentQueue()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<ExperimentQueue> o)
    {
        if (o == null)
            return false;

        ExperimentQueueListTO to = new ExperimentQueueListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public ExperimentQueueListTO clone()
    {
        return (ExperimentQueueListTO) super.clone();
    }
}
