/* gromit: IExperimentRunListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for IExperimentRunTO .java
 * ==============================================================================
...
import org.seamless_ip.ontologies.seamproj.IExperimentRun;
import org.seamless_ip.services.transferobjects.seamproj.IExperimentRunTO;
...
public class IExperimentRunListTO<TOType, OntoType> extends ArrayList<IExperimentRunTO<TOType, OntoType>> implements Serializable, Cloneable	
{
    ...
    public IExperimentRunListTO<TOType, OntoType> assignFrom(Set<IExperimentRun> o)
    {
        clear();
        if (o != null) {
            for (IExperimentRun obj : o)
            {
    	//this is the transport object (TO) management of interfaces fields!
		try {
			//obj is an instance of the interface IExperimentRun    
			...
			IExperimentRunTO instance = ((IExperimentRunTO)(Class.forName(TOclassname).newInstance()));
    ...
    public Set<IExperimentRun> assignTo(Set<IExperimentRun> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<IExperimentRun> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		IExperimentRun dbItem = iter.next();
        		boolean found = false;
        		for (IExperimentRunTO<TOType, OntoType> toItem : this)
        		{
            ...
            for (IExperimentRunTO<TOType, OntoType> toItem : this)
            {
            	...
            	if (!found)
            	{
                    ...
                    //o.add(toItem.assignTo(new IExperimentRun()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<IExperimentRun> o)
    {
        if (o == null)
            return false;

        IExperimentRunListTO<TOType, OntoType> to = new IExperimentRunListTO<TOType, OntoType>().assignFrom(o);
    ...
    @Override
    @SuppressWarnings("unchecked")
    public IExperimentRunListTO<TOType, OntoType> clone()
    {
        return (IExperimentRunListTO<TOType, OntoType>) super.clone();
    }
}
