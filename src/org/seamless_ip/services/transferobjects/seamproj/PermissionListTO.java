/* gromit: PermissionListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for PermissionTO .java
 * ==============================================================================
...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.seamproj.Permission", readonly=false, used=true)
@SuppressWarnings("serial")
public class PermissionListTO extends ArrayList<PermissionTO> implements Serializable, Cloneable	
{
    ...
    public PermissionListTO assignFrom(Set<Permission> o)
    {
        clear();
        if (o != null) {
            for (Permission obj : o)
            {
    			add(new PermissionTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Permission> assignTo(Set<Permission> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Permission> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Permission dbItem = iter.next();
        		boolean found = false;
        		for (PermissionTO toItem : this)
        		{
            ...
            for (PermissionTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Permission()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Permission> o)
    {
        if (o == null)
            return false;

        PermissionListTO to = new PermissionListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public PermissionListTO clone()
    {
        return (PermissionListTO) super.clone();
    }
}
