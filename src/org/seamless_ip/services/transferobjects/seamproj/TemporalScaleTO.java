/*  
 * TemporalScaleTO.java; Jun 5, 2009
 * ==============================================================================
...
@CodegeneratorSettings(sourcename = "org.seamless_ip.ontologies.seamproj.TemporalScale", readonly = true, used = true)
@SuppressWarnings("serial")
public class TemporalScaleTO extends AbstractTO
		implements IScaleTO<TemporalScaleTO, TemporalScale>, Serializable, Cloneable
{
	...
	public static int notOverwriteTemporalScaleTO;
	...
	public TemporalScaleTO() {
		super();
	}

	public static TemporalScale createDBInstance() {
		TemporalScale dbItem = new TemporalScale();
		dbItem.setRank(new Integer(0));
		return dbItem;
	}

	public static TemporalScale createDBInstance(TemporalScaleTO toItem) {
		if (toItem != null)
	...
	public static void releaseDBInstance(TemporalScale dbItem) {
		if (dbItem != null) {
		}
	}
	 ...
	 */
	public TemporalScaleTO assignFrom(TemporalScale source) {
		if (source != null) {
			setId(source.getId());
	 ...
	 */
	public TemporalScale assignTo(TemporalScale target) {
		TemporalScale result = target;
		if ((result != null) && (!equalsTo(result))) {
			result = new TemporalScale();
			result.setId(getId());
	...
	public boolean equalsTo(TemporalScale target) {
		if (target == null)
			return false;

		TemporalScaleTO targetTO = new TemporalScaleTO().assignFrom(target);
		return targetTO.equals(this);
	}

	@Override
	public TemporalScaleTO clone() {
		TemporalScaleTO clone = new TemporalScaleTO();
		clone.setId(_id);
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof TemporalScaleTO))
			return false;

		TemporalScaleTO classTO = (TemporalScaleTO) o;
