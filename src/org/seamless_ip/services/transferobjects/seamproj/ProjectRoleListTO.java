/* gromit: ProjectRoleListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for ProjectRoleTO .java
 * ==============================================================================
...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.seamproj.ProjectRole", readonly=false, used=true)
@SuppressWarnings("serial")
public class ProjectRoleListTO extends ArrayList<ProjectRoleTO> implements Serializable, Cloneable	
{
    ...
    public ProjectRoleListTO assignFrom(Set<ProjectRole> o)
    {
        clear();
        if (o != null) {
            for (ProjectRole obj : o)
            {
    			add(new ProjectRoleTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<ProjectRole> assignTo(Set<ProjectRole> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<ProjectRole> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		ProjectRole dbItem = iter.next();
        		boolean found = false;
        		for (ProjectRoleTO toItem : this)
        		{
            ...
            for (ProjectRoleTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new ProjectRole()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<ProjectRole> o)
    {
        if (o == null)
            return false;

        ProjectRoleListTO to = new ProjectRoleListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public ProjectRoleListTO clone()
    {
        return (ProjectRoleListTO) super.clone();
    }
}
