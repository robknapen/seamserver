/*  
 * PolicyOptionNarrativeTO.java; Jun 5, 2009
 * ==============================================================================
...
public class PolicyOptionNarrativeTO extends AbstractTO
		implements TO<PolicyOptionNarrativeTO, PolicyOption>, Serializable, Cloneable
{
	...
	public static int notOverwritePolicyOptionNarrativeTO;
	...
	public PolicyOptionNarrativeTO() {
		super();
	...
	public static PolicyOption createDBInstance(PolicyOptionNarrativeTO toItem) {
		if (toItem != null)
	...
	public PolicyOptionNarrativeTO assignFrom(PolicyOption target) {
		if (target != null) {
			try {
	...
	public boolean equalsTo(PolicyOption target) {
		...
		PolicyOptionNarrativeTO targetTO = new PolicyOptionNarrativeTO()
				.assignFrom(target);
		return targetTO.equals(this);
	}

	@Override
	public PolicyOptionNarrativeTO clone() {
		PolicyOptionNarrativeTO clone = new PolicyOptionNarrativeTO();
		clone.setId(_id);
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof PolicyOptionNarrativeTO))
			return false;

		PolicyOptionNarrativeTO classTO = (PolicyOptionNarrativeTO) o;
