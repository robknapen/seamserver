/* gromit: SpatialScaleListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for SpatialScaleTO .java
 * ==============================================================================
...
public class SpatialScaleListTO extends ArrayList<SpatialScaleTO> implements Serializable, Cloneable	
{
    ...
    public SpatialScaleListTO assignFrom(Set<SpatialScale> o)
    {
        clear();
        if (o != null) {
            for (SpatialScale obj : o)
            {
    			add(new SpatialScaleTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<SpatialScale> assignTo(Set<SpatialScale> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<SpatialScale> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		SpatialScale dbItem = iter.next();
        		boolean found = false;
        		for (SpatialScaleTO toItem : this)
        		{
            ...
            for (SpatialScaleTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new SpatialScale()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<SpatialScale> o)
    {
        if (o == null)
            return false;

        SpatialScaleListTO to = new SpatialScaleListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public SpatialScaleListTO clone()
    {
        return (SpatialScaleListTO) super.clone();
    }
}
