/* gromit: OutlookListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for OutlookTO .java
 * ==============================================================================
...
public class OutlookListTO extends ArrayList<OutlookTO> implements Serializable, Cloneable	
{
    ...
    public OutlookListTO assignFrom(Set<Outlook> o)
    {
        clear();
        if (o != null) {
            for (Outlook obj : o)
            {
    			add(new OutlookTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Outlook> assignTo(Set<Outlook> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Outlook> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Outlook dbItem = iter.next();
        		boolean found = false;
        		for (OutlookTO toItem : this)
        		{
            ...
            for (OutlookTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Outlook()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Outlook> o)
    {
        if (o == null)
            return false;

        OutlookListTO to = new OutlookListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public OutlookListTO clone()
    {
        return (OutlookListTO) super.clone();
    }
}
