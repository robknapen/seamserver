/* gromit: UserListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for UserTO .java
 * ==============================================================================
...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.seamproj.User", readonly=false, used=true)
@SuppressWarnings("serial")
public class UserListTO extends ArrayList<UserTO> implements Serializable, Cloneable	
{
    ...
    public UserListTO assignFrom(Set<User> o)
    {
        clear();
        if (o != null) {
            for (User obj : o)
            {
    			add(new UserTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<User> assignTo(Set<User> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<User> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		User dbItem = iter.next();
        		boolean found = false;
        		for (UserTO toItem : this)
        		{
            ...
            for (UserTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new User()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<User> o)
    {
        if (o == null)
            return false;

        UserListTO to = new UserListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public UserListTO clone()
    {
        return (UserListTO) super.clone();
    }
}
