/* gromit: ModelListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for ModelTO .java
 * ==============================================================================
...
public class ModelListTO extends ArrayList<ModelTO> implements Serializable, Cloneable	
{
    ...
    public ModelListTO assignFrom(Set<Model> o)
    {
        clear();
        if (o != null) {
            for (Model obj : o)
            {
    			add(new ModelTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Model> assignTo(Set<Model> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Model> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Model dbItem = iter.next();
        		boolean found = false;
        		for (ModelTO toItem : this)
        		{
            ...
            for (ModelTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Model()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Model> o)
    {
        if (o == null)
            return false;

        ModelListTO to = new ModelListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public ModelListTO clone()
    {
        return (ModelListTO) super.clone();
    }
}
