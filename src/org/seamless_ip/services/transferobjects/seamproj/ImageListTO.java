/* gromit: ImageListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for ImageTO .java
 * ==============================================================================
...
import org.seamless_ip.services.transferobjects.seamproj.ImageTO;
...
public class ImageListTO extends ArrayList<ImageTO> implements Serializable, Cloneable	
{
    ...
    public ImageListTO assignFrom(Set<Image> o)
    {
        clear();
        if (o != null) {
            for (Image obj : o)
            {
    			add(new ImageTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Image> assignTo(Set<Image> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Image> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Image dbItem = iter.next();
        		boolean found = false;
        		for (ImageTO toItem : this)
        		{
            ...
            for (ImageTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Image()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Image> o)
    {
        if (o == null)
            return false;

        ImageListTO to = new ImageListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public ImageListTO clone()
    {
        return (ImageListTO) super.clone();
    }
}
