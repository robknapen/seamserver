/* gromit: PolicyOptionListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for PolicyOptionTO .java
 * ==============================================================================
...
public class PolicyOptionListTO extends ArrayList<PolicyOptionTO> implements Serializable, Cloneable	
{
    ...
    public PolicyOptionListTO assignFrom(Set<PolicyOption> o)
    {
        clear();
        if (o != null) {
            for (PolicyOption obj : o)
            {
    			add(new PolicyOptionTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<PolicyOption> assignTo(Set<PolicyOption> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<PolicyOption> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		PolicyOption dbItem = iter.next();
        		boolean found = false;
        		for (PolicyOptionTO toItem : this)
        		{
            ...
            for (PolicyOptionTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new PolicyOption()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<PolicyOption> o)
    {
        if (o == null)
            return false;

        PolicyOptionListTO to = new PolicyOptionListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public PolicyOptionListTO clone()
    {
        return (PolicyOptionListTO) super.clone();
    }
}
