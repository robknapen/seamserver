/* gromit: IProductionItemListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for IProductionItemTO .java
 * ==============================================================================
...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.capri.IProductionItem", readonly=false, used=true)
@SuppressWarnings("serial")
public class IProductionItemListTO<TOType, OntoType> extends ArrayList<IProductionItemTO<TOType, OntoType>> implements Serializable, Cloneable	
{
    ...
    public IProductionItemListTO<TOType, OntoType> assignFrom(Set<IProductionItem> o)
    {
        clear();
        if (o != null) {
            for (IProductionItem obj : o)
            {
    	//this is the transport object (TO) management of interfaces fields!
		try {
			//obj is an instance of the interface IProductionItem    
			...
			IProductionItemTO instance = ((IProductionItemTO)(Class.forName(TOclassname).newInstance()));
    ...
    public Set<IProductionItem> assignTo(Set<IProductionItem> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<IProductionItem> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		IProductionItem dbItem = iter.next();
        		boolean found = false;
        		for (IProductionItemTO<TOType, OntoType> toItem : this)
        		{
            ...
            for (IProductionItemTO<TOType, OntoType> toItem : this)
            {
            	...
            	if (!found)
            	{
                    ...
                    //o.add(toItem.assignTo(new IProductionItem()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<IProductionItem> o)
    {
        if (o == null)
            return false;

        IProductionItemListTO<TOType, OntoType> to = new IProductionItemListTO<TOType, OntoType>().assignFrom(o);
    ...
    @Override
    @SuppressWarnings("unchecked")
    public IProductionItemListTO<TOType, OntoType> clone()
    {
        return (IProductionItemListTO<TOType, OntoType>) super.clone();
    }
}
