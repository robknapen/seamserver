/* gromit: DemandShiftListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for DemandShiftTO .java
 * ==============================================================================
...
public class DemandShiftListTO extends ArrayList<DemandShiftTO> implements Serializable, Cloneable	
{
    ...
    public DemandShiftListTO assignFrom(Set<DemandShift> o)
    {
        clear();
        if (o != null) {
            for (DemandShift obj : o)
            {
    			add(new DemandShiftTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<DemandShift> assignTo(Set<DemandShift> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<DemandShift> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		DemandShift dbItem = iter.next();
        		boolean found = false;
        		for (DemandShiftTO toItem : this)
        		{
            ...
            for (DemandShiftTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new DemandShift()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<DemandShift> o)
    {
        if (o == null)
            return false;

        DemandShiftListTO to = new DemandShiftListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public DemandShiftListTO clone()
    {
        return (DemandShiftListTO) super.clone();
    }
}
