/* gromit: YieldGrowthListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for YieldGrowthTO .java
 * ==============================================================================
...
public class YieldGrowthListTO extends ArrayList<YieldGrowthTO> implements Serializable, Cloneable	
{
    ...
    public YieldGrowthListTO assignFrom(Set<YieldGrowth> o)
    {
        clear();
        if (o != null) {
            for (YieldGrowth obj : o)
            {
    			add(new YieldGrowthTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<YieldGrowth> assignTo(Set<YieldGrowth> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<YieldGrowth> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		YieldGrowth dbItem = iter.next();
        		boolean found = false;
        		for (YieldGrowthTO toItem : this)
        		{
            ...
            for (YieldGrowthTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new YieldGrowth()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<YieldGrowth> o)
    {
        if (o == null)
            return false;

        YieldGrowthListTO to = new YieldGrowthListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public YieldGrowthListTO clone()
    {
        return (YieldGrowthListTO) super.clone();
    }
}
