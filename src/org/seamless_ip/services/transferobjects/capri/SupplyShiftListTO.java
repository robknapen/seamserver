/* gromit: SupplyShiftListTO.java 
 * ==============================================================================
 * Manually copied from DemandShiftTO as a short term solution.
 * List of Transport Object class for SupplyShiftTO.java
 * ==============================================================================
...
public class SupplyShiftListTO extends ArrayList<SupplyShiftTO> implements Serializable, Cloneable	
{
    ...
    public SupplyShiftListTO assignFrom(Set<SupplyShift> o)
    {
        clear();
        if (o != null) {
            for (SupplyShift obj : o)
            {
    			add(new SupplyShiftTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<SupplyShift> assignTo(Set<SupplyShift> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<SupplyShift> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		SupplyShift dbItem = iter.next();
        		boolean found = false;
        		for (SupplyShiftTO toItem : this)
        		{
            ...
            for (SupplyShiftTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new SupplyShift()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<SupplyShift> o)
    {
        if (o == null)
            return false;

        SupplyShiftListTO to = new SupplyShiftListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public SupplyShiftListTO clone()
    {
        return (SupplyShiftListTO) super.clone();
    }
}
