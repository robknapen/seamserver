/* gromit: InflationRateListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for InflationRateTO .java
 * ==============================================================================
...
public class InflationRateListTO extends ArrayList<InflationRateTO> implements Serializable, Cloneable	
{
    ...
    public InflationRateListTO assignFrom(Set<InflationRate> o)
    {
        clear();
        if (o != null) {
            for (InflationRate obj : o)
            {
    			add(new InflationRateTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<InflationRate> assignTo(Set<InflationRate> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<InflationRate> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		InflationRate dbItem = iter.next();
        		boolean found = false;
        		for (InflationRateTO toItem : this)
        		{
            ...
            for (InflationRateTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new InflationRate()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<InflationRate> o)
    {
        if (o == null)
            return false;

        InflationRateListTO to = new InflationRateListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public InflationRateListTO clone()
    {
        return (InflationRateListTO) super.clone();
    }
}
