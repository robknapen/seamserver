...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.capri.InflationRate", readonly=false, used=true)
@SuppressWarnings("serial")
public class InflationRateTO extends AbstractTO implements ICAPRIParameterTO<InflationRateTO, InflationRate>, Serializable, Cloneable 	
{
	private Long _id;		
	...
	public InflationRateTO()
	{
		super();
		_countryaggregate = new CountryAggregateTO();
	}

	public static InflationRate createDBInstance()
	{
		InflationRate dbItem = new InflationRate();
		dbItem.setCountryAggregate(CountryAggregateTO.createDBInstance());
		return dbItem;
	}


	public static InflationRate createDBInstance(InflationRateTO toItem)
	{
		if (toItem != null)
    ...
    public static void releaseDBInstance(InflationRate dbItem)
    {
        if (dbItem != null) {
    ...
    public InflationRateTO assignFrom(InflationRate target)	
	{
		if (target != null)
		{
			try {
    ...
    public InflationRate assignTo(InflationRate target)
    {
        if (target != null) 
        {
    ...
    public boolean equalsTo(InflationRate target)
    {
        if (target == null)
            return false;

        InflationRateTO targetTO = new InflationRateTO().assignFrom(target);
        return targetTO.equals(this);
    }
    
    @Override
    public InflationRateTO clone()
    {
    	InflationRateTO clone = new InflationRateTO();
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof InflationRateTO)) return false;

        InflationRateTO classTO = (InflationRateTO) o;
