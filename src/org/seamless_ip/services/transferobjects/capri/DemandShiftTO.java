...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.capri.DemandShift", readonly=false, used=true)
@SuppressWarnings("serial")
public class DemandShiftTO extends AbstractTO implements ICAPRIParameterTO<DemandShiftTO, DemandShift>, Serializable, Cloneable 	
{
	...
	public static DemandShift createDBInstance()
	{
		DemandShift dbItem = new DemandShift();
	...
	public static DemandShift createDBInstance(DemandShiftTO toItem)
	{
		if (toItem != null)
    ...
    public static void releaseDBInstance(DemandShift dbItem)
    {
        if (dbItem != null) {
    ...
    public DemandShiftTO assignFrom(DemandShift target)	
	{
		if (target != null)
		{
			try {
    ...
    public DemandShift assignTo(DemandShift target)
    {
        if (target != null) 
        {
    ...
    public boolean equalsTo(DemandShift target)
    {
        if (target == null)
            return false;

        DemandShiftTO targetTO = new DemandShiftTO().assignFrom(target);
        return targetTO.equals(this);
    }
    
    @Override
    public DemandShiftTO clone()
    {
    	DemandShiftTO clone = new DemandShiftTO();
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof DemandShiftTO)) return false;

        DemandShiftTO classTO = (DemandShiftTO) o;
