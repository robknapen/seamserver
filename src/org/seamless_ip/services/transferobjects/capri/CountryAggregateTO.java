/* gromit: CountryAggregateTO .java
 * ==============================================================================
...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.capri.CountryAggregate", readonly=false, used=true)
@SuppressWarnings("serial")
public class CountryAggregateTO extends AbstractTO implements IRegionTO<CountryAggregateTO, CountryAggregate>, Serializable, Cloneable 	
{
	...
	public CountryAggregateTO()
	{
		super();
	}

	public static CountryAggregate createDBInstance()
	{
		CountryAggregate dbItem = new CountryAggregate();
		return dbItem;
	}


	public static CountryAggregate createDBInstance(CountryAggregateTO toItem)
	{
		if (toItem != null)
    ...
    public static void releaseDBInstance(CountryAggregate dbItem)
    {
        if (dbItem != null) {
        }
    }

    public CountryAggregateTO assignFrom(CountryAggregate target)	
	{
		if (target != null)
		{
			try {
    ...
    public CountryAggregate assignTo(CountryAggregate target)
    {
        if (target != null) 
        {
			target.setId(_id);			
    ...
    public boolean equalsTo(CountryAggregate target)
    {
        if (target == null)
            return false;

        CountryAggregateTO targetTO = new CountryAggregateTO().assignFrom(target);
        return targetTO.equals(this);
    }
    
    @Override
    public CountryAggregateTO clone()
    {
    	CountryAggregateTO clone = new CountryAggregateTO();
		clone.setId(_id);
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof CountryAggregateTO)) return false;

        CountryAggregateTO classTO = (CountryAggregateTO) o;
