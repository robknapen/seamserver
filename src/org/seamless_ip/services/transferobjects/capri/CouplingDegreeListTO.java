/* gromit: CouplingDegreeListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for CouplingDegreeTO .java
 * ==============================================================================
...
public class CouplingDegreeListTO extends ArrayList<CouplingDegreeTO> implements Serializable, Cloneable	
{
    ...
    public CouplingDegreeListTO assignFrom(Set<CouplingDegree> o)
    {
        clear();
        if (o != null) {
            for (CouplingDegree obj : o)
            {
    			add(new CouplingDegreeTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<CouplingDegree> assignTo(Set<CouplingDegree> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<CouplingDegree> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		CouplingDegree dbItem = iter.next();
        		boolean found = false;
        		for (CouplingDegreeTO toItem : this)
        		{
            ...
            for (CouplingDegreeTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new CouplingDegree()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<CouplingDegree> o)
    {
        if (o == null)
            return false;

        CouplingDegreeListTO to = new CouplingDegreeListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public CouplingDegreeListTO clone()
    {
        return (CouplingDegreeListTO) super.clone();
    }
}
