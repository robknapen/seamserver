/* gromit: BiofuelDemandListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for BiofuelDemandTO .java
 * ==============================================================================
...
public class BiofuelDemandListTO extends ArrayList<BiofuelDemandTO> implements Serializable, Cloneable	
{
    ...
    public BiofuelDemandListTO assignFrom(Set<BiofuelDemand> o)
    {
        clear();
        if (o != null) {
            for (BiofuelDemand obj : o)
            {
    			add(new BiofuelDemandTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<BiofuelDemand> assignTo(Set<BiofuelDemand> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<BiofuelDemand> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		BiofuelDemand dbItem = iter.next();
        		boolean found = false;
        		for (BiofuelDemandTO toItem : this)
        		{
            ...
            for (BiofuelDemandTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new BiofuelDemand()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<BiofuelDemand> o)
    {
        if (o == null)
            return false;

        BiofuelDemandListTO to = new BiofuelDemandListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public BiofuelDemandListTO clone()
    {
        return (BiofuelDemandListTO) super.clone();
    }
}
