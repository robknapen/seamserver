...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.capri.CouplingDegree", readonly=false, used=true)
@SuppressWarnings("serial")
public class CouplingDegreeTO extends AbstractTO implements ICAPRIParameterTO<CouplingDegreeTO, CouplingDegree>, Serializable, Cloneable 	
{
	...
	public static CouplingDegree createDBInstance()
	{
		CouplingDegree dbItem = new CouplingDegree();
	...
	public static CouplingDegree createDBInstance(CouplingDegreeTO toItem)
	{
		if (toItem != null)
    ...
    public static void releaseDBInstance(CouplingDegree dbItem)
    {
        if (dbItem != null) {
    ...
    public CouplingDegreeTO assignFrom(CouplingDegree target)	
	{
		if (target != null)
		{
			try {
    ...
    public CouplingDegree assignTo(CouplingDegree target)
    {
        if (target != null) 
        {
    ...
    public boolean equalsTo(CouplingDegree target)
    {
        if (target == null)
            return false;

        CouplingDegreeTO targetTO = new CouplingDegreeTO().assignFrom(target);
        return targetTO.equals(this);
    }
    
    @Override
    public CouplingDegreeTO clone()
    {
    	CouplingDegreeTO clone = new CouplingDegreeTO();
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof CouplingDegreeTO)) return false;

        CouplingDegreeTO classTO = (CouplingDegreeTO) o;
