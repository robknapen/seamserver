/* gromit: ExchangeRatesListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for ExchangeRatesTO .java
 * ==============================================================================
...
public class ExchangeRatesListTO extends ArrayList<ExchangeRatesTO> implements Serializable, Cloneable	
{
    ...
    public ExchangeRatesListTO assignFrom(Set<ExchangeRates> o)
    {
        clear();
        if (o != null) {
            for (ExchangeRates obj : o)
            {
    			add(new ExchangeRatesTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<ExchangeRates> assignTo(Set<ExchangeRates> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<ExchangeRates> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		ExchangeRates dbItem = iter.next();
        		boolean found = false;
        		for (ExchangeRatesTO toItem : this)
        		{
            ...
            for (ExchangeRatesTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new ExchangeRates()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<ExchangeRates> o)
    {
        if (o == null)
            return false;

        ExchangeRatesListTO to = new ExchangeRatesListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public ExchangeRatesListTO clone()
    {
        return (ExchangeRatesListTO) super.clone();
    }
}
