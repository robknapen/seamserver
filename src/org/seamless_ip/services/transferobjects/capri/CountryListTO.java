/* gromit: CountryListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for CountryTO .java
 * ==============================================================================
...
public class CountryListTO extends ArrayList<CountryTO> implements Serializable, Cloneable	
{
    ...
    public CountryListTO assignFrom(Set<Country> o)
    {
        clear();
        if (o != null) {
            for (Country obj : o)
            {
    			add(new CountryTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Country> assignTo(Set<Country> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Country> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Country dbItem = iter.next();
        		boolean found = false;
        		for (CountryTO toItem : this)
        		{
            ...
            for (CountryTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Country()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Country> o)
    {
        if (o == null)
            return false;

        CountryListTO to = new CountryListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public CountryListTO clone()
    {
        return (CountryListTO) super.clone();
    }
}
