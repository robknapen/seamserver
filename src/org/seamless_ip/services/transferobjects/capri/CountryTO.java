...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.capri.Country", readonly=false, used=true)
@SuppressWarnings("serial")
public class CountryTO extends AbstractTO implements IRegionTO<CountryTO, Country>, Serializable, Cloneable 	
{
	...
	public static Country createDBInstance()
	{
		Country dbItem = new Country();
		return dbItem;
	}


	public static Country createDBInstance(CountryTO toItem)
	{
		if (toItem != null)
    ...
    public static void releaseDBInstance(Country dbItem)
    {
        if (dbItem != null) {
        }
    }

    public CountryTO assignFrom(Country target)	
	{
		if (target != null)
		{
			try {
    ...
    public Country assignTo(Country target)
    {
        if (target != null) 
        {
			target.setId(_id);			
    ...
    public boolean equalsTo(Country target)
    {
        if (target == null)
            return false;

        CountryTO targetTO = new CountryTO().assignFrom(target);
        return targetTO.equals(this);
    }
    
    @Override
    public CountryTO clone()
    {
    	CountryTO clone = new CountryTO();
		clone.setId(_id);
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof CountryTO)) return false;

        CountryTO classTO = (CountryTO) o;
