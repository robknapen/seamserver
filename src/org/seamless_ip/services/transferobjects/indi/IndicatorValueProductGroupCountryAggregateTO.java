/*  
 * IndicatorValueProductGroupCountryAggregateTO.java; Jun 5, 2009
 * ==============================================================================
 ...
 */
public class IndicatorValueProductGroupCountryAggregateTO extends IndicatorValueTO implements IIndicatorValueTO<IndicatorValueProductGroupCountryAggregateTO, IndicatorValueProductGroupCountryAggregate>, Cloneable
{
	...
	public static int notOverwriteIndicatorValueProductGroupCountryAggregateTO;
	
	public IndicatorValueProductGroupCountryAggregateTO assignFrom(
			IndicatorValueProductGroupCountryAggregate source) {
		if (source != null) {
	...
	public IndicatorValueProductGroupCountryAggregate assignTo(
			IndicatorValueProductGroupCountryAggregate target) {
		return (IndicatorValueProductGroupCountryAggregate) super
				.assignTo(target);
	}

	public boolean equalsTo(IndicatorValueProductGroupCountryAggregate target) {
		if (target == null)
			return false;

		IndicatorValueProductGroupCountryAggregateTO targetTO = new IndicatorValueProductGroupCountryAggregateTO()
				.assignFrom(target);
		return targetTO.equals(this);
	}

	public IndicatorValueProductGroupCountryAggregateTO clone() {
		IndicatorValueProductGroupCountryAggregateTO clone = new IndicatorValueProductGroupCountryAggregateTO();
		clone.setId(getId());
