/* gromit: IndicatorGroupListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for IndicatorGroupTO .java
 * ==============================================================================
...
public class IndicatorGroupListTO extends ArrayList<IndicatorGroupTO> implements Serializable, Cloneable	
{
    ...
    public IndicatorGroupListTO assignFrom(Set<IndicatorGroup> o)
    {
        clear();
        if (o != null) {
            for (IndicatorGroup obj : o)
            {
    			add(new IndicatorGroupTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<IndicatorGroup> assignTo(Set<IndicatorGroup> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<IndicatorGroup> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		IndicatorGroup dbItem = iter.next();
        		boolean found = false;
        		for (IndicatorGroupTO toItem : this)
        		{
            ...
            for (IndicatorGroupTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new IndicatorGroup()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<IndicatorGroup> o)
    {
        if (o == null)
            return false;

        IndicatorGroupListTO to = new IndicatorGroupListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public IndicatorGroupListTO clone()
    {
        return (IndicatorGroupListTO) super.clone();
    }
}
