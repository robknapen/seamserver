/*  
 * IndicatorValueFarmTO.java; Jun 5, 2009
 * ==============================================================================
 ...
 */
public class IndicatorValueFarmTO extends IndicatorValueTO implements IIndicatorValueTO<IndicatorValueFarmTO, IndicatorValueFarm>, Cloneable
{
	...
	public static int notOverwriteIndicatorValueFarmTO;

	
	public IndicatorValueFarmTO assignFrom(IndicatorValueFarm source) {
		if (source != null) {
	...
	public IndicatorValueFarm assignTo(IndicatorValueFarm target) {
		return (IndicatorValueFarm) super.assignTo(target);
	}

	public boolean equalsTo(IndicatorValueFarm target) {
		if (target == null)
			return false;

		IndicatorValueFarmTO targetTO = new IndicatorValueFarmTO()
				.assignFrom(target);
		return targetTO.equals(this);
	}

	public IndicatorValueFarmTO clone() {
		IndicatorValueFarmTO clone = new IndicatorValueFarmTO();
		clone.setId(getId());
