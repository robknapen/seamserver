/*  
 * IndicatorValueProductGroupCountryTO.java; Jun 5, 2009
 * ==============================================================================
 ...
 */
public class IndicatorValueProductGroupCountryTO extends IndicatorValueTO implements IIndicatorValueTO<IndicatorValueProductGroupCountryTO, IndicatorValueProductGroupCountry>, Cloneable
{
	...
	public static int notOverwriteIndicatorValueProductGroupCountryTO;

	public IndicatorValueProductGroupCountryTO assignFrom(
			IndicatorValueProductGroupCountry source) {
		if (source != null) {
	...
	public IndicatorValueProductGroupCountry assignTo(
			IndicatorValueProductGroupCountry target) {
		return (IndicatorValueProductGroupCountry) super.assignTo(target);
	}

	public boolean equalsTo(IndicatorValueProductGroupCountry target) {
		if (target == null)
			return false;

		IndicatorValueProductGroupCountryTO targetTO = new IndicatorValueProductGroupCountryTO()
				.assignFrom(target);
		return targetTO.equals(this);
	}

	public IndicatorValueProductGroupCountryTO clone() {
		IndicatorValueProductGroupCountryTO clone = new IndicatorValueProductGroupCountryTO();
		clone.setId(getId());
