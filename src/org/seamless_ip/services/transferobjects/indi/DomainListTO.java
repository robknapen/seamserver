/* gromit: DomainListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for DomainTO .java
 * ==============================================================================
...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.indi.Domain", readonly=false, used=true)
@SuppressWarnings("serial")
public class DomainListTO extends ArrayList<DomainTO> implements Serializable, Cloneable	
{
    ...
    public DomainListTO assignFrom(Set<Domain> o)
    {
        clear();
        if (o != null) {
            for (Domain obj : o)
            {
    			add(new DomainTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Domain> assignTo(Set<Domain> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Domain> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Domain dbItem = iter.next();
        		boolean found = false;
        		for (DomainTO toItem : this)
        		{
            ...
            for (DomainTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Domain()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Domain> o)
    {
        if (o == null)
            return false;

        DomainListTO to = new DomainListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public DomainListTO clone()
    {
        return (DomainListTO) super.clone();
    }
}
