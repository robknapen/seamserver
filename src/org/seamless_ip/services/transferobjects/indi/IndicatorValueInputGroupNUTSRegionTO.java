/*  
 * IndicatorValueInputGroupNUTSRegionTO.java; Jun 5, 2009
 * ==============================================================================
 ...
 */
public class IndicatorValueInputGroupNUTSRegionTO extends IndicatorValueTO implements IIndicatorValueTO<IndicatorValueInputGroupNUTSRegionTO, IndicatorValueInputGroupNUTSRegion>, Cloneable
{
	...
	public static int notOverwriteIndicatorValueInputGroupNUTSRegionTO;

	public IndicatorValueInputGroupNUTSRegionTO assignFrom(
			IndicatorValueInputGroupNUTSRegion source) {
		if (source != null) {
	...
	public IndicatorValueInputGroupNUTSRegion assignTo(
			IndicatorValueInputGroupNUTSRegion target) {
		return (IndicatorValueInputGroupNUTSRegion) super.assignTo(target);
	}

	public boolean equalsTo(IndicatorValueInputGroupNUTSRegion target) {
		if (target == null)
			return false;

		IndicatorValueInputGroupNUTSRegionTO targetTO = new IndicatorValueInputGroupNUTSRegionTO()
				.assignFrom(target);
		return targetTO.equals(this);
	}

	public IndicatorValueInputGroupNUTSRegionTO clone() {
		IndicatorValueInputGroupNUTSRegionTO clone = new IndicatorValueInputGroupNUTSRegionTO();
		clone.setId(getId());
