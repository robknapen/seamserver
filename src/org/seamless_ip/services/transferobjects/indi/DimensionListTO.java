/* gromit: DimensionListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for DimensionTO .java
 * ==============================================================================
...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.indi.Dimension", readonly=false, used=true)
@SuppressWarnings("serial")
public class DimensionListTO extends ArrayList<DimensionTO> implements Serializable, Cloneable	
{
    ...
    public DimensionListTO assignFrom(Set<Dimension> o)
    {
        clear();
        if (o != null) {
            for (Dimension obj : o)
            {
    			add(new DimensionTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Dimension> assignTo(Set<Dimension> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Dimension> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Dimension dbItem = iter.next();
        		boolean found = false;
        		for (DimensionTO toItem : this)
        		{
            ...
            for (DimensionTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Dimension()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Dimension> o)
    {
        if (o == null)
            return false;

        DimensionListTO to = new DimensionListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public DimensionListTO clone()
    {
        return (DimensionListTO) super.clone();
    }
}
