/*  
 * IndicatorValueCropTO.java; Jun 5, 2009
 * ==============================================================================
 ...
 */
public class IndicatorValueCropTO extends IndicatorValueTO implements IIndicatorValueTO<IndicatorValueCropTO, IndicatorValueCrop>, Cloneable
{
	...
	public static int notOverwriteIndicatorValueCropTO;
	
	public IndicatorValueCropTO assignFrom(IndicatorValueCrop source) {
		if (source != null) {
			super.assignFrom(source);
			setValue(source.getValue());
			addProperty("Crop:Id", source.getCrop().getId());
			addProperty("Crop:Label_en", source.getCrop().getLabel_en());
	...
	public IndicatorValueCrop assignTo(IndicatorValueCrop target) {
		return (IndicatorValueCrop) super.assignTo(target);
	}

	public boolean equalsTo(IndicatorValueCrop target) {
		if (target == null)
			return false;

		IndicatorValueCropTO targetTO = new IndicatorValueCropTO()
				.assignFrom(target);
		return targetTO.equals(this);
	}

	public IndicatorValueCropTO clone() {
		IndicatorValueCropTO clone = new IndicatorValueCropTO();
		clone.setId(getId());
