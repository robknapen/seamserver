/*  
 * IndicatorValueActivityGroupNUTSRegionTO.java; Jun 5, 2009
 * ==============================================================================
 ...
 */
public class IndicatorValueActivityGroupNUTSRegionTO extends IndicatorValueTO implements IIndicatorValueTO<IndicatorValueActivityGroupNUTSRegionTO, IndicatorValueActivityGroupNUTSRegion>, Cloneable
{
	...
	public static int notOverwriteIndicatorValueActivityGroupNUTSRegionTO;

	
	public IndicatorValueActivityGroupNUTSRegionTO assignFrom(
			IndicatorValueActivityGroupNUTSRegion source) {
		if (source != null) {
	...
	public IndicatorValueActivityGroupNUTSRegion assignTo(
			IndicatorValueActivityGroupNUTSRegion target) {
		return (IndicatorValueActivityGroupNUTSRegion) super.assignTo(target);
	}

	public boolean equalsTo(IndicatorValueActivityGroupNUTSRegion target) {
		if (target == null)
			return false;

		IndicatorValueActivityGroupNUTSRegionTO targetTO = new IndicatorValueActivityGroupNUTSRegionTO()
				.assignFrom(target);
		return targetTO.equals(this);
	}

	public IndicatorValueActivityGroupNUTSRegionTO clone() {
		IndicatorValueActivityGroupNUTSRegionTO clone = new IndicatorValueActivityGroupNUTSRegionTO();
		clone.setId(getId());
