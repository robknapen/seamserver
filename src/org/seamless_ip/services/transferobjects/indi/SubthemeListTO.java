/* gromit: SubthemeListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for SubthemeTO .java
 * ==============================================================================
...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.indi.Subtheme", readonly=false, used=true)
@SuppressWarnings("serial")
public class SubthemeListTO extends ArrayList<SubthemeTO> implements Serializable, Cloneable	
{
    ...
    public SubthemeListTO assignFrom(Set<Subtheme> o)
    {
        clear();
        if (o != null) {
            for (Subtheme obj : o)
            {
    			add(new SubthemeTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Subtheme> assignTo(Set<Subtheme> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Subtheme> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Subtheme dbItem = iter.next();
        		boolean found = false;
        		for (SubthemeTO toItem : this)
        		{
            ...
            for (SubthemeTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Subtheme()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Subtheme> o)
    {
        if (o == null)
            return false;

        SubthemeListTO to = new SubthemeListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public SubthemeListTO clone()
    {
        return (SubthemeListTO) super.clone();
    }
}
