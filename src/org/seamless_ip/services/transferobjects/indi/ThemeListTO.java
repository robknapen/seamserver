/* gromit: ThemeListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for ThemeTO .java
 * ==============================================================================
...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.indi.Theme", readonly=false, used=true)
@SuppressWarnings("serial")
public class ThemeListTO extends ArrayList<ThemeTO> implements Serializable, Cloneable	
{
    ...
    public ThemeListTO assignFrom(Set<Theme> o)
    {
        clear();
        if (o != null) {
            for (Theme obj : o)
            {
    			add(new ThemeTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Theme> assignTo(Set<Theme> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Theme> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Theme dbItem = iter.next();
        		boolean found = false;
        		for (ThemeTO toItem : this)
        		{
            ...
            for (ThemeTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Theme()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Theme> o)
    {
        if (o == null)
            return false;

        ThemeListTO to = new ThemeListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public ThemeListTO clone()
    {
        return (ThemeListTO) super.clone();
    }
}
