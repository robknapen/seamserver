/*  
 * IndicatorValueNUTSRegionTO.java; Jun 5, 2009
 * ==============================================================================
 ...
 */
public class IndicatorValueNUTSRegionTO extends IndicatorValueTO implements IIndicatorValueTO<IndicatorValueNUTSRegionTO, IndicatorValueNUTSRegion>, Cloneable
{
	...
	public static int notOverwriteIndicatorValueNUTSRegionTO;

	
	public IndicatorValueNUTSRegionTO assignFrom(IndicatorValueNUTSRegion source) {
		if (source != null) {
	...
	public IndicatorValueNUTSRegion assignTo(IndicatorValueNUTSRegion target) {
		return (IndicatorValueNUTSRegion) super.assignTo(target);
	}

	public boolean equalsTo(IndicatorValueNUTSRegion target) {
		if (target == null)
			return false;

		IndicatorValueNUTSRegionTO targetTO = new IndicatorValueNUTSRegionTO()
				.assignFrom(target);
		return targetTO.equals(this);
	}

	public IndicatorValueNUTSRegionTO clone() {
		IndicatorValueNUTSRegionTO clone = new IndicatorValueNUTSRegionTO();
		clone.setId(getId());
