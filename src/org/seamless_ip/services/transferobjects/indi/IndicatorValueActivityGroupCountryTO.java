/*  
 * IndicatorValueActivityGroupCountryTO.java; Jun 5, 2009
 * ==============================================================================
 ...
 */
public class IndicatorValueActivityGroupCountryTO extends IndicatorValueTO implements IIndicatorValueTO<IndicatorValueActivityGroupCountryTO, IndicatorValueActivityGroupCountry>, Cloneable
{
	...
	public static int notOverwriteIndicatorValueActivityGroupCountryTO;

	
	public IndicatorValueActivityGroupCountryTO assignFrom(
			IndicatorValueActivityGroupCountry source) {
		if (source != null) {
	...
	public IndicatorValueActivityGroupCountry assignTo(
			IndicatorValueActivityGroupCountry target) {
		return (IndicatorValueActivityGroupCountry) super.assignTo(target);
	}

	public boolean equalsTo(IndicatorValueActivityGroupCountry target) {
		if (target == null)
			return false;

		IndicatorValueActivityGroupCountryTO targetTO = new IndicatorValueActivityGroupCountryTO()
				.assignFrom(target);
		return targetTO.equals(this);
	}

	public IndicatorValueActivityGroupCountryTO clone() {
		IndicatorValueActivityGroupCountryTO clone = new IndicatorValueActivityGroupCountryTO();
		clone.setId(getId());
