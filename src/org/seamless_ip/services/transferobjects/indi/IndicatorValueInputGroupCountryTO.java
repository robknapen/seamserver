/*  
 * IndicatorValueInputGroupCountryTO.java; Jun 5, 2009
 * ==============================================================================
 ...
 */
public class IndicatorValueInputGroupCountryTO extends IndicatorValueTO implements IIndicatorValueTO<IndicatorValueInputGroupCountryTO, IndicatorValueInputGroupCountry>, Cloneable
{
	...
	public static int notOverwriteIndicatorValueInputGroupCountryTO;

	
	public IndicatorValueInputGroupCountryTO assignFrom(
			IndicatorValueInputGroupCountry source) {
		if (source != null) {
	...
	public IndicatorValueInputGroupCountry assignTo(
			IndicatorValueInputGroupCountry target) {
		return (IndicatorValueInputGroupCountry) super.assignTo(target);
	}

	public boolean equalsTo(IndicatorValueInputGroupCountry target) {
		if (target == null)
			return false;

		IndicatorValueInputGroupCountryTO targetTO = new IndicatorValueInputGroupCountryTO()
				.assignFrom(target);
		return targetTO.equals(this);
	}

	public IndicatorValueInputGroupCountryTO clone() {
		IndicatorValueInputGroupCountryTO clone = new IndicatorValueInputGroupCountryTO();
		clone.setId(getId());
