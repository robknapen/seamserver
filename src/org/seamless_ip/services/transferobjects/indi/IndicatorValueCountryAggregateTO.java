/*  
 * IndicatorValueCountryAggregateTO.java; Jun 5, 2009
 * ==============================================================================
 ...
 */
public class IndicatorValueCountryAggregateTO extends IndicatorValueTO implements IIndicatorValueTO<IndicatorValueCountryAggregateTO, IndicatorValueCountryAggregate>, Cloneable
{
	...
	public static int notOverwriteIndicatorValueCountryAggregateTO;

	
	public IndicatorValueCountryAggregateTO assignFrom(
			IndicatorValueCountryAggregate source) {
		if (source != null) {
	...
	public IndicatorValueCountryAggregate assignTo(
			IndicatorValueCountryAggregate target) {
		return (IndicatorValueCountryAggregate) super.assignTo(target);
	}

	public boolean equalsTo(IndicatorValueCountryAggregate target) {
		if (target == null)
			return false;

		IndicatorValueCountryAggregateTO targetTO = new IndicatorValueCountryAggregateTO()
				.assignFrom(target);
		return targetTO.equals(this);
	}

	public IndicatorValueCountryAggregateTO clone() {
		IndicatorValueCountryAggregateTO clone = new IndicatorValueCountryAggregateTO();
		clone.setId(getId());
