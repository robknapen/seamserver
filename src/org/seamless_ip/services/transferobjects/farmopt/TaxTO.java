...
public class TaxTO extends AbstractTO implements IPolicyMeasureTO<TaxTO, Tax>, Serializable, Cloneable 	
{
	...
	public static Tax createDBInstance()
	{
		Tax dbItem = new Tax();
	...
	public static Tax createDBInstance(TaxTO toItem)
	{
		if (toItem != null)
    ...
    public static void releaseDBInstance(Tax dbItem)
    {
        if (dbItem != null) {
    ...
    public TaxTO assignFrom(Tax target)	
	{
		if (target != null)
		{
			try {
    ...
    public Tax assignTo(Tax target)
    {
        if (target != null) 
        {
    ...
    public boolean equalsTo(Tax target)
    {
        if (target == null)
            return false;

        TaxTO targetTO = new TaxTO().assignFrom(target);
    ...
    public int hashCode()
    {
		...
		result = 31 * result + (_tax != null ? _tax .hashCode() : 0);
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof TaxTO)) return false;

        TaxTO classTO = (TaxTO) o;
		...
		if (_id != null ? !_id .equals(classTO._id) : classTO._id != null)
			return false;
		if (_tax != null ? !_tax .equals(classTO._tax) : classTO._tax != null)
			return false;
