/* gromit: ITaxListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for ITaxTO .java
 * ==============================================================================
...
import org.seamless_ip.ontologies.farmopt.ITax;
import org.seamless_ip.services.transferobjects.farmopt.ITaxTO;
...
@CodegeneratorSettings(sourcename="org.seamless_ip.ontologies.farmopt.ITax", readonly=false, used=true)
@SuppressWarnings("serial")
public class ITaxListTO<TOType, OntoType> extends ArrayList<ITaxTO<TOType, OntoType>> implements Serializable, Cloneable	
{
    ...
    public ITaxListTO<TOType, OntoType> assignFrom(Set<ITax> o)
    {
        clear();
        if (o != null) {
            for (ITax obj : o)
		...
		try {
			//obj is an instance of the interface ITax    
			...
			ITaxTO instance = ((ITaxTO)(Class.forName(TOclassname).newInstance()));
    ...
    public Set<ITax> assignTo(Set<ITax> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<ITax> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		ITax dbItem = iter.next();
        		boolean found = false;
        		for (ITaxTO<TOType, OntoType> toItem : this)
        		{
            ...
            for (ITaxTO<TOType, OntoType> toItem : this)
            {
            	...
            	if (!found)
            	{
                    ...
                    //o.add(toItem.assignTo(new ITax()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<ITax> o)
    {
        if (o == null)
            return false;

        ITaxListTO<TOType, OntoType> to = new ITaxListTO<TOType, OntoType>().assignFrom(o);
    ...
    @Override
    @SuppressWarnings("unchecked")
    public ITaxListTO<TOType, OntoType> clone()
    {
        return (ITaxListTO<TOType, OntoType>) super.clone();
    }
}
