/* gromit: PenaltyListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for PenaltyTO .java
 * ==============================================================================
...
public class PenaltyListTO extends ArrayList<PenaltyTO> implements Serializable, Cloneable	
{
    ...
    public PenaltyListTO assignFrom(Set<Penalty> o)
    {
        clear();
        if (o != null) {
            for (Penalty obj : o)
            {
    			add(new PenaltyTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Penalty> assignTo(Set<Penalty> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Penalty> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Penalty dbItem = iter.next();
        		boolean found = false;
        		for (PenaltyTO toItem : this)
        		{
            ...
            for (PenaltyTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Penalty()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Penalty> o)
    {
        if (o == null)
            return false;

        PenaltyListTO to = new PenaltyListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public PenaltyListTO clone()
    {
        return (PenaltyListTO) super.clone();
    }
}
