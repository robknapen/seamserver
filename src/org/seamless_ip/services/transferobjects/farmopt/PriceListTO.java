/* gromit: PriceListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for PriceTO .java
 * ==============================================================================
...
public class PriceListTO extends ArrayList<PriceTO> implements Serializable, Cloneable	
{
    ...
    public PriceListTO assignFrom(Set<Price> o)
    {
        clear();
        if (o != null) {
            for (Price obj : o)
            {
    			add(new PriceTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<Price> assignTo(Set<Price> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<Price> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		Price dbItem = iter.next();
        		boolean found = false;
        		for (PriceTO toItem : this)
        		{
            ...
            for (PriceTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new Price()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<Price> o)
    {
        if (o == null)
            return false;

        PriceListTO to = new PriceListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public PriceListTO clone()
    {
        return (PriceListTO) super.clone();
    }
}
