/* gromit: YieldTrendListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for YieldTrendTO .java
 * ==============================================================================
...
import org.seamless_ip.services.transferobjects.farmopt.YieldTrendTO;
...
public class YieldTrendListTO extends ArrayList<YieldTrendTO> implements Serializable, Cloneable	
{
    ...
    public YieldTrendListTO assignFrom(Set<YieldTrend> o)
    {
        clear();
        if (o != null) {
            for (YieldTrend obj : o)
            {
    			add(new YieldTrendTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<YieldTrend> assignTo(Set<YieldTrend> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<YieldTrend> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		YieldTrend dbItem = iter.next();
        		boolean found = false;
        		for (YieldTrendTO toItem : this)
        		{
            ...
            //can be updated! 
            for (YieldTrendTO toItem : this) {
            	for (YieldTrend dbItem : o) {
            		if (dbItem.getId() != null && toItem.getId() != null && dbItem.getId().compareTo(toItem.getId()) == 0) {            			
						if (dbItem.getYield().compareTo(toItem.getYield()) != 0) {						
							//Update all Floats 
							dbItem.setYield(toItem.getYield());
            			}
            		}
            	}
            }
            ...
            for (YieldTrendTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new YieldTrend()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<YieldTrend> o)
    {
        if (o == null)
            return false;

        YieldTrendListTO to = new YieldTrendListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public YieldTrendListTO clone()
    {
        return (YieldTrendListTO) super.clone();
    }
}
