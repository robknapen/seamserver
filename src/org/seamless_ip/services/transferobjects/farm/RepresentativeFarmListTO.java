/* gromit: RepresentativeFarmListTO .java 
 * ==============================================================================
 * (This code was generated by a tool)
 * List of Transport Object class for RepresentativeFarmTO .java
 * ==============================================================================
...
public class RepresentativeFarmListTO extends ArrayList<RepresentativeFarmTO> implements Serializable, Cloneable	
{
    ...
    public RepresentativeFarmListTO assignFrom(Set<RepresentativeFarm> o)
    {
        clear();
        if (o != null) {
            for (RepresentativeFarm obj : o)
            {
    			add(new RepresentativeFarmTO().assignFrom(obj));
            }
        }
        return this;
    }
    ...
    public Set<RepresentativeFarm> assignTo(Set<RepresentativeFarm> o)
    {
        ...
        if (o != null) {
        	...
        	Iterator<RepresentativeFarm> iter = o.iterator();
        	while (iter.hasNext())
        	{
        		RepresentativeFarm dbItem = iter.next();
        		boolean found = false;
        		for (RepresentativeFarmTO toItem : this)
        		{
            ...
            //can be updated! 
            for (RepresentativeFarmTO toItem : this) {
            	for (RepresentativeFarm dbItem : o) {
            ...
            for (RepresentativeFarmTO toItem : this)
            {
            	...
            	if (!found)
            	{
					o.add(toItem.assignTo(new RepresentativeFarm()));
	         }   
            }            	
        }
        return o;
    ...
    public boolean equalsTo(Set<RepresentativeFarm> o)
    {
        if (o == null)
            return false;

        RepresentativeFarmListTO to = new RepresentativeFarmListTO().assignFrom(o);
        return to.equals(this);
    }


    @Override
    public RepresentativeFarmListTO clone()
    {
        return (RepresentativeFarmListTO) super.clone();
    }
}
